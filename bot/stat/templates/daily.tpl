...
$(function () {
    ...
    $.get('json/topup', function (json) {
    	loadTopupStats(json);
    });
    
    $("#container4").load("google/summary");
    
    $("#container6").load("topup/summary");
    ...
    $("#dailySearch").click(function (e) {
    	...
    	$.get('json/daily/' + startDate + '/' + endDate + '/' + market, function (json) {
        	loadDailyStats(json);
        });
    });
    
    $("#topupSearch").click(function (e) {
    	e.preventDefault();
    	var startDate = $("#topup_start_date").val();
    	var endDate = $("#topup_end_date").val();
    	$.get('json/topup/' + startDate + '/' + endDate, function (json) {
        	loadTopupStats(json);
        });
        
    	$("#container6").load('topup/summary/' + startDate + '/' + endDate);    
    });
...
Market: <select name='market' id='market'><option value='a'>All</option><option value='g' selected>German</option><option value='e'>English</option></select>
...
<div id="container5" style="margin: 0 auto"></div>
<div id="container6" style="margin: 0 auto"></div>

Start Date: <input class='datepicker' type='text' id='topup_start_date' name='start_date' value='{$day_start}' />
End Date: <input class='datepicker' type='text' id='topup_end_date' name='start_date' value='{$day_finish}' />
<button class='btn btn-primary btn-sm' id='topupSearch'>Search</button>

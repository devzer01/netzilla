...
function getMsgArea(){
    ...
    var site2 = [5,10,39,46,54,50,51,55,56,57,58,59,60,63,66,67,68,69,71,73,78];
...
<?php include('inc.nav.php');?>
        ...
        <form name="selectpage" id="selectpage" action="#" method="post" onsubmit="checkform(doNotShowAlert); return false;"> <!---->
            ...
            <span class="field" id="message"></span>
            <br class="clear">
...
<div style="clear: both"></div>
    <div id="updateStatus" style="margin: 10px 0; text-align: center; padding: 10px; background-color: green; color: #fff;">
        Please click to GET/UPDATE bot status (On this page status update when click Only !!!!)
    </div>
<div style="width: 100%;">
    <div id="showstatus" style="margin:15px 15px 15px 15px; float:left; border: dashed 1ps #F00"></div>
</div>
<script type="text/javascript">
    var bot = {
        mask: function(name) {
...
<script type="text/javascript">
    _.init();
    _.page = '<?php echo $_SERVER['PHP_SELF']; ?>';
</script>
</body>
</html>
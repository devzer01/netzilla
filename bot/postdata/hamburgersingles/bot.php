	...
	public function login()
	{
		...
		if(!($this->isLoggedIn($username)))
		{
			...
			for($count_login=1; $count_login<=$this->loginRetry; $count_login++)
			{
				...
				if(strpos($content, 'Wir mussten dein Profil leider sperren') == true ) {
					$this->savelog('[failed] Account : '.$username.' has erros / Response : Wir mussten dein Profil leider sperren');
				}

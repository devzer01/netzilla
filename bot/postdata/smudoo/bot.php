...
class bot
{
		...
		if(!($this->isLoggedIn($username)))
		{
			...
			for($count_login=1; $count_login<=$this->loginRetry; $count_login++)
			{
				...
				elseif(!($this->isLoggedIn($username)))
				{
					...
					echo "<textarea>" . $this->userAgent . " " . $content . "</textarea>";
	...
	protected function getHTTPContent($url, $referer, $cookiePath=null, $postContent=null, $get_info = TRUE, &$header = null, $use_ajax_header = false)
	{
		$ch = curl_init();

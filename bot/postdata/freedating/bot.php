...
class bot
{
	...
	protected $userAgent = "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:26.0) Gecko/20100101 Firefox/26.0";
	...
	public function login()
	{
		...
		if(!($this->isLoggedIn($username)))
		{
			...
			for($count_login=1; $count_login<=$this->loginRetry; $count_login++)
			{
				...
				// Log
				$content = $this->getHTTPContent($this->rootDomain, $this->rootDomain, $cookiePath);
				$this->loginArr[$this->currentUser]['fraw'] = $this->userAgent.'###1080x1920x24###-420###Shockwave Flash::Shockwave Flash 11.2 r202::application/x-shockwave-flash~swf,application/futuresplash~spl;Windows Media Player Plug-in 10 (compatible; Videos)::The <a href="http://www.gnome.org/">Videos</a> 3.8.2 plugin handles video and audio streams.::application/x-mplayer2~avi, wma, wmv,video/x-ms-asf-plugin~asf, wmv,video/x-msvideo~asf, wmv,video/x-ms-asf~asf,video/x-ms-wmv~wmv,video/x-wmv~wmv,video/x-ms-wvx~wmv,video/x-ms-wm~wmv,video/x-ms-wmp~wmv,application/x-ms-wms~wms,application/x-ms-wmp~wmp,application/asx~asx,audio/x-ms-wma~wma;VLC Multimedia Plugin (compatible Videos 3.8.2)::The <a href="http://www.gnome.org/">Videos</a> 3.8.2 plugin handles video and audio streams.::application/x-vlc-plugin~,application/vlc~,video/x-google-vlc-plugin~,application/x-ogg~ogg,application/ogg~ogg,audio/ogg~oga,audio/x-ogg~ogg,audio/x-vorbis+ogg~ogg,video/ogg~ogv,video/x-ogg~ogg,video/x-theora+ogg~ogg,application/annodex~anx,audio/annodex~axa,video/annodex~axv,video/mpeg~mpg, mpeg, mpe,audio/wav~wav,audio/x-wav~wav,audio/mpeg~mp3,application/x-nsv-vp3-mp3~nsv,video/flv~flv,video/webm~webm,application/x-totem-plugin~,audio/midi~mid, midi;QuickTime Plug-in 7.6.6::The <a href="http://www.gnome.org/">Videos</a> 3.8.2 plugin handles video and audio streams.::video/quicktime~mov,video/mp4~mp4,image/x-macpaint~pntg,image/x-quicktime~pict, pict1, pict2,video/x-m4v~m4v,application/vnd.apple.mpegurl~m3u8;DivX® Web Player::DivX Web Player version 1.4.0.233::video/divx~divx;iTunes Application Detector::This plug-in detects the presence of iTunes when opening iTunes Store URLs in a web page with Firefox.::application/itunes-plugin~';

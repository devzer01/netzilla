	...
	public function login()
	{
		...
		if(!($this->isLoggedIn($username)))
		{
			...
			for($count_login=1; $count_login<=$this->loginRetry; $count_login++)
			{
				...
				elseif(strpos($content, "You don't have permission to access") !== false)
				{
						$this->savelog("User ".$username." have been Block.");
	...
	public function reLogin($username)
	{
		...
		if(!($this->isLoggedIn($username)))
		{
			...
			for($count_login=1; $count_login<=$this->loginRetry; $count_login++)
			{
				...
				$content = $this->getHTTPContent("http://www.ab18.de/community/index.php", $this->loginRefererURL, $cookiePath);

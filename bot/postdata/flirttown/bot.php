...
class bot
{
	...
	public function login()
	{
		...
		if(!($this->isLoggedIn($username)))
		{
			...
			for($count_login=1; $count_login<=$this->loginRetry; $count_login++)
			{
				...
				//file_put_contents("login/".$username."-".date("YmdHis").".html",$content2);
	...
	protected function isLoggedIn($username)
	{
		...
		$content = $this->getHTTPContent("http://www.flirttown.net/content/left.php", $this->loginRefererURL, $cookiePath);

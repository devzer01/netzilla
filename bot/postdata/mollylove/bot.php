	...
	public function login()
	{
		...
		if(!($this->isLoggedIn($username)))
		{
			...
			for($count_login=1; $count_login<=$this->loginRetry; $count_login++)
			{
				...
				//$content = $this->getHTTPContent("http://www.mollylove.de/phpinc/cc.php?do=start&what=checkLogin&nick=".$username."&isM=0&secl=0&SID=".$this->sid, "http://www.mollylove.de/", $cookiePath);

...
class funcs
{
	...
	{
		$sql = "SELECT username,userid FROM phonefling_member WHERE gender='".$post['search_sex']."' AND username NOT IN (SELECT to_username FROM phonefling_sent_messages) AND ((id-1)%12)=(".BOT_ID."-1) ORDER BY DATE(created_datetime) DESC, id ASC LIMIT 1";

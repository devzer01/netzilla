...
function getMsgArea(){
	...
	var site1 = [5,10,35,39,46,54,55,56,57,58,59,60,66,67,68,69,71,73,78];
	var site2 = [5,10,39,46,54,55,56,57,58,59,60,66,67,68,69,71,73,78];
...
function getRepeatProfile(){
	site = parseInt($("select[name=site]").val());
	var site_ids = [5,10,35,39,46,54,55,56,57,58,59,60,66,67,68,69,71,73,78];

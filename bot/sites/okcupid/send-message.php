...
$loginRefererURL = "http://www.okcupid.com";
$searchURL = "http://www.okcupid.com/match";
$searchReferer = "http://www.okcupid.com/match?timekey=1&matchOrderBy=SPECIAL_BLEND&use_prefs=1&discard_prefs=1";
$searchResultsPerPage = 100;
$sendMessageURL = "http://www.okcupid.com/mailbox";
$sendMessageRefererURL = "http://www.okcupid.com/profile/";

$receiverInboxURL = "http://www.okcupid.com/messages";
...
else
{
	...
	$receiverId			= "";
	$receiverUsername	= "OsmiumTheHutt";
	$receiverPassword	= "3drfzOZuGy";
}

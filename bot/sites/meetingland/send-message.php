...
$loginURL = "http://www.meetingland.com/home.php";
$loginRefererURL = "http://www.meetingland.com/";
$searchURL = "http://www.proximeety.co.uk/index2.php?page_id=search";
$searchReferer = "http://www.meetingland.com/profiles/search";
$searchResultsPerPage = 20;
$sendMessageURL = "http://www.proximeety.net/submit_msg.php";
$sendMessageRefererURL = "http://www.proximeety.co.uk/index2.php?page_id=send_msg&view_id=";

$receiverInboxURL = "http://www.proximeety.co.uk/";
...
else
{
	...
	$command = array(
						"profiles" => array(
												array(
														"username" => "jennyherman51@yahoo.com",
														"password" => "meme123123"
													)
											),
						"messages" => array(
						...
						"country" => "9-0",	//England
						//"country" => "4-0",	//USA
						//"country" => "10-0",	//Australia
						//"country" => "5-0",	//Canada
						//"country" => "11-0",	//New Zealand
						//"country" => "12-0",	//Ireland
						//"country" => "8-0",	//Scotland
						"gender" => "Male",
						"action" => "search"
						//"action" => "send"
					);

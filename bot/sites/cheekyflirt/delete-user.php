...
// 	$sql = "delete from lotsoflove_user_profile where id = $deleteId limit 1";
	$sql = "UPDATE  `botmessage`.`cheekyflirt_user_profile` SET  `status` =  'false' WHERE  `cheekyflirt_user_profile`.`id` = $deleteId limit 1";
	if(mysql_query($sql))
	{

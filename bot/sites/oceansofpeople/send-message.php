...
{
	$loginURL = "http://www.oceansofpeople.com/default.aspx";
	$loginRefererURL = "http://www.oceansofpeople.com/";
	$searchURL = "http://www.oceansofpeople.com/BasicSearch.aspx";
	$searchReferer = "http://www.oceansofpeople.com/BasicSearch.aspx";
	$sendMessageURL = "http://www.oceansofpeople.com/ViewProfile.aspx?profile=";
	$sendMessageRefererURL = "http://www.oceansofpeople.com/ViewProfile.aspx?profile=";
	$receiverInboxURL = "http://www.oceansofpeople.com/MesssageBoard.aspx";
...
elseif(isset($_GET['command']) && ($_GET['command']=="BAND"))
{
	...
	//{
		$profile['username'] = "mariorangins";
		$profile['password'] = "Qmiw13o";

...
$loginURL = "http://www.profilepic.com/do/signin";
$loginRefererURL = "http://www.profilepic.com";
$searchURL = "http://www.profilepic.com/page/browse";
$searchReferer = "http://www.profilepic.com/page/browse";
$searchResultsPerPage = 8;
$sendMessageURL = "http://www.profilepic.com/do/send_message/";
$sendMessageRefererURL = "http://www.profilepic.com/";
...
else
{
	...
	$command = array(
						"profiles" => array(
												array(
														"username" => "sonyadefore@yahoo.com",
														"password" => "smooch323"
													)
											),
						"messages" => array(
	...
	$receiverId			= "40417";
	$receiverUsername	= "alan_dover@ymail.com";

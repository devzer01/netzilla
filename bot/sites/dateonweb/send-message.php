...
if($_POST)
{
	...
	$loginURL = "http://www.dateonweb.net/member.php";
	$loginRefererURL = "http://www.dateonweb.net";
	$searchURL = "http://www.dateonweb.net/search_result.php";
	$searchReferer = "http://www.dateonweb.net/search.php";
	$sendMessageURL = "http://www.dateonweb.net/compose.php?ID=";
...
//	$sendMessageURL = "http://www.single123.com/account/messages/compose/";
	...
	$receiverInboxURL = "http://www.dateonweb.net/inbox.php?message=";
}
else
{
	define("ID",1);
	...
	$command = array(
						"profiles" => array(
												array(
														"username" => "rosiebell669@yahoo.com",
														"password" => "R2021982b"
													)
											),
						"messages" => array(

...
SmartyPaginate::setUrl("?action=".$_GET['action']?$_GET['action']:""."&type=".$_GET['type']?$_GET['type']:""); //smarty paging set URL
	...
	default:
		...
		{	
			case 'outbox':
				...
				if(isset($_POST['action']) && ($_POST['action']=="delete") && (count($_POST['messageid'])>0))
				{

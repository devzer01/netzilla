	...
	<td>
		<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<br><br><br></form>		
    			...
    			<td align="center" class="text14grey">	
				<b>Mitgliedschafts Übersicht</b><br><br>
		...
		{else}
			...
			<br><br>
			Dieses Abonement w&auml;re g&uuml;ltig bis zum: <b>{$dauer}</b><br>
			...
			<input type="hidden" name="return" value="http://www.sonaflirt.com">
			...
			<tr align="center"><td class="text12black">Dieses Abonement w&auml;re g&uuml;ltig bis zum: {$dauer}</td></tr>
			<tr align="center"><td class="text14grey" height="25"></td></tr>
			...
			<tr align="center"><td class="text14grey" height="25"></td></tr>		
		 <table>
			<tr><td width="150"></td><td class="text12black">Kontoinhaber:</td><td class="text12grey"><b>Loox GmbH</b></td></tr>	
			<tr><td width="150"></td><td class="text12black">Kontonummer:</td><td class="text12grey"><b>17092590</b></td></tr>	
			<tr><td width="150"></td><td class="text12black">Bankleitzahl:</td><td class="text12grey"><b>21550050</b></td></tr>	
			<tr><td width="150"></td><td class="text12black">Institut:</td><td class="text12grey"><b>Flensburger Sparkasse</b></td></tr>		
			<tr><td width="150"></td><td class="text12black">Verwendungszweck:</td><td class="text12grey"><b>{$vzweck}</b></td></tr>		
			<tr><td width="150"></td><td class="text12black">Betrag:</td><td class="text12grey"><b>{$preis} Euro</b></td></tr>		
		 </table>	 
		{/if}

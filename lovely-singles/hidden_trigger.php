...
// Änderung HAUKE
require_once('conf/ger.php');
require_once('classes/top.class.php'); 
    
$paylog_no = $params['ret_booknr'];
$paylog_data_id = $_POST['paylog_id'];

$sql = "UPDATE ".TABLE_PAY_LOG." SET transaction_no = '".$paylog_no."' WHERE id = $paylog_data_id";

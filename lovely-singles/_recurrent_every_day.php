...
$sql = "SELECT ID, username FROM payment_log WHERE reminder_date = CURDATE() AND recall = '0'";
...
$query = "select id, username
    from member
    where isactive = 1
      and isactive_datetime < '".date("Y-m-d H:i:s", time()- DEACTIVATION_PERIOD *24*60*60)."';";

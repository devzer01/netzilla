...
<div class="result-box">
	...
	<tr>
		<td>Date/Time:</td><td><input type="text" name="datetime" id="datetime" readonly="readonly"/> (GMT+1)</td>
	</tr>
	<tr>
		<td>Coins:</td><td><input type="text" name="coins" id="coins" value="650"/></td>
	</tr>
	<tr>

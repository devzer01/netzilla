	...
	<tr>			
		...
		<table align="center" border="0" cellpadding="4" cellspacing="0" width="500">
			<tr height="28">
				...
				{else}
				<input id="to" name="to" type="text" style="width:180px" value="{$save.to}" class="input">
				{/if}
				{if $messageid.0 neq ""}
			...
			<tr height="28">
				<td><b>Subject:</b></td>
				<td><input id="subject" name="subject" type="text" style="width:180px" value="{$save.subject}" class="input"></td>
			</tr>
			<tr height="28">

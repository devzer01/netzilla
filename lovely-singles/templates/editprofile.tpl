...
<br class="clear" /> <input name="" type="checkbox" value=""  checked="checked"/> Alle Nachrichten als SMS erhalten (Bitte die Handynummer verifizieren)
</div>
...
<div class="container-edit-profile-group">
	...
	<span>
		<textarea id="description" name="description" columns="20" rows="12" style="width:450px" class="textarea" onkeyup="checkNullTextArea(this, 'Bitte teilen Sie uns abit mehr über sich.')" onblur="checkNullTextArea(this, 'Bitte teilen Sie uns abit mehr über sich.')">{$save.description|stripslashes}</textarea>	
	</span>
	<br clear="all"/>
	<label></label>

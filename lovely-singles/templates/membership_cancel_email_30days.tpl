	...
	<td>
		...
		<tr>
			<td>
				...
				<br>
				Dadurch, dass Sie Ihr 1-Monats-Abo nicht fristgerecht gekündigt haben, hat es sich bedingungsgemü in ein 3-Monats- Abo verlängert. Da Sie sich mit der Zahlung für den ersten Abrechnungszeitraum in Verzug befinden, ist der Gesamtbetrag für die Restlaufzeit des Vertrages (3-Monats-Abo) sofort in voller Höhe fällig.
				<br>
		...
		<tr>
			<td align="center">
				{$entry.total} EUR<br>
				<u>&nbsp;&nbsp;&nbsp;{$entry.price_3_months} EUR&nbsp;&nbsp;&nbsp;</u><br><br>
				{math equation="x + y" x=$entry.total y=$entry.price_3_months} EUR<br>
				<br>
			</td>
		</tr>
		<tr>

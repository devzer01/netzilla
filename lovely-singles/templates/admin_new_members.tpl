<div class="result-box">
	...
	<div class="result-box-inside-nobg">
		...
		<tr>
			<td>
				<a href="#" onclick="checkWithChatServer('', 'checkAllWithChatServer')" class="link-inrow">Check all with chat server</a>
			</td>
		</tr>
		{/if}
		<tr>
			...
			{if $userrec}
				...
				<tr  bgcolor="{cycle values="#663333,#996666"}" height="28px">
					...
					<td align="center"><a href="?action=viewprofile&username={$userdata.username}&from=admin" class="link-inrow">{$userdata.username}</a></td>
					...
					<td align="center">
						{if $userdata.isactive}
							...
							<span id='check_{$userdata.user_id}'>|| <a href="#" onclick="checkWithChatServer('{$userdata.user_id}', 'checkWithChatServer'); return false;"  class="link-inrow">Check</a></span>
							<span id='sync_{$userdata.user_id}' style="display: none">|| <a href="#" onclick="checkWithChatServer('{$userdata.user_id}', 'syncWithChatServer'); return false;"  class="link-inrow">Syncronize</a></span>
							<span id='resend_{$userdata.user_id}' style="display: none">|| <a href="#" onclick="checkWithChatServer('{$userdata.user_id}', 'resendNewRegistrationMessage'); return false;"  class="link-inrow">resend</a></span>
						{/if}
					</td>
				</tr>
				{/foreach}

...
<tr>
<td><img src="{$url_web}images/mail-header.jpg" width="800" height="205" style="display: block;" /></td>
</tr>
<tr>
<td style="border:1px; border-style:solid; border-color:#696969; background:#b6b6b6;">
<table width="782" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30" style="font-family:tahoma, Helvetica, sans-serif; font-size:14px; color:#b83232; font-weight:bold;">{#Dear#} {$username},</td>
  </tr>
</table>
<table width="782" border="0" align="center" cellpadding="0" cellspacing="0">
<tr>

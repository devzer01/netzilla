	...
	<div class="register-page-box-inside">
		...
		<form id="register_form" name="register_form" method="post" action="?action=incompleteinfo_skip">	
			...
			<label class="text">&nbsp;</label>
				...
				<a href="javascript: void(0)" onclick="if(checkNullSignup2()) $('register_form').submit();" class="button">{#reg2_submit#}</a><br class="clear"/>
				<label class="text">&nbsp;</label>
				...
				<a href="{if $smarty.session.mobileverify_redirect eq ''}./{else}{$smarty.session.mobileverify_redirect}{/if}" onclick="" class="button">{#reg2_skip#}</a>
				{/if}
				<br clear="all" />
		</form>

<div class="menubarcon">
	...
	{if $smarty.session.sess_username}
		<span><a href="?action=pay-for-coins"><img src="images/coinstack.png" style="float:left; margin:8px 5px 0 0; border:none;" alt="" /></a><span id="coinsArea" style="padding: 0px">
		{if $coin}
			{$coin}
		{else}
			0

...
{elseif $descriptions}
	<form action="" method="post">
	<table border="1" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
...
{elseif $delete_accounts}
	...
	<tr>
		<td align="center" style="border: solid 1px #FFFFFF;background: #b6b6b6;">{$item.username}</td>
		<td align="center" style="border: solid 1px #FFFFFF;background: #b6b6b6;">{$item.delete_datetime}</td>
		<td align="center" style="border: solid 1px #FFFFFF;background: #b6b6b6;"><a href="?action=admin_manageuser&user={$item.username}&proc=del" onclick="return confirm(confirm_delete_box)" title="Delete">

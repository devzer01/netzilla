...
{if $smarty.session.sess_permission eq 1}
	...
	{if $submenu eq "admin_manage_contents"}
		...
		<a href="?action=admin_manage_contents&page=terms-2" class="left-menusub">{#MANAGE_TERMS#} (ES)</a>
		...
		<a href="?action=admin_manage_contents&page=policy-2" class="left-menusub">{#MANAGE_PRIVACY#} (ES)</a>
		<a href="?action=admin_manage_contents&page=refund" class="left-menusub">{#MANAGE_REFUND#} (DE)</a>
		<a href="?action=admin_manage_contents&page=refund-2" class="left-menusub">{#MANAGE_REFUND#} (ES)</a>
	{/if}

...
define('MAIL_REPLYTO_EMAIL',"noreply@flirten48.net");
define('MAIL_REPLYTO_NAME',"Flirten48.Net Activation");
...
define('ENABLE_PAYMENT_REALEX', 1);
define('REALEX_TEST_MODE', 1);

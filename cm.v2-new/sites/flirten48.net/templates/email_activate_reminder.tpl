{include file="email_header.tpl"}
				...
				<tr>
					<td valign="top" style="font-family:tahoma, Helvetica, sans-serif; padding:10px; text-align:left; line-height:20px;  font-weight:bold; font-size:14px;">
						Du hast dich vor kurzem auf unserer Flirtseite Flirten48.net registriert. <br/>
						...
						<br />Viel Spaß & Flirterfolg auf Flirten48.net!<br /> 
						<img src='{$url_web}?action=email_read&username={$username}' height="1" width="1" />
					</td>
				</tr>
				</table>

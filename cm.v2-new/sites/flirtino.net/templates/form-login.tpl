<div class="container-login-box">
	<div class="container-login">
		...
		<input name="l_username" id="l_username" type="text" class="formfield_01" onkeypress="enterLogin(event)" placeholder="{#USERNAME#}" style=" width:215px; margin-right:10px"/>
		<input name="l_password" id="l_password" type="password" class="formfield_01" onkeypress="enterLogin(event)" placeholder="{#PASSWORD#}" style=" width:215px;"/><br class="clear" />
		<div style="float:left; margin-bottom:10px; margin-top:8px;"><input  name="remember" id="remember" type="checkbox" value="1" />{#Remember_me#}</div>
	...
	<div class="container-register">
		...
		<input name="username" type="text" class="formfield_01" style=" width:215px; margin-right:10px" placeholder="{#USERNAME#}" AUTOCOMPLETE="OFF"/>
		<input name="email" type="text"  class="formfield_01" style=" width:215px;" placeholder="{#Email#}" autocomplete='off'/><br class="clear" />

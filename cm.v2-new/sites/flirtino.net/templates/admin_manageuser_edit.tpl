...
<div style="float:left; width: 500px">	
	...
	<span>
		<select id="q_country" name="country" onchange="loadOptionState('#q_state', this.options[this.selectedIndex].value, '');loadOptionCity('#q_city', jQuery('#q_state')[jQuery('#q_state').selectedIndex].value, '')" class="formfield_01"><option></option></select>
	</span>
	<br class="clear"/>
	...
	<br class="clear" />
    <a href="#" onclick="jQuery('#editprofileForm').submit(); return false;" class="btn-admin">Save</a>
</div>

<div style="float: left;"><img src="thumbnails.php?file={$profile.picturepath}&w=200&h=200"/></div>
<br class="clear" />
</form>
</div></div>

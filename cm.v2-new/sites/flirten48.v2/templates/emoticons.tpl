...
<a id="emtclose" class="close-gift-box"><span>Close</span></a>
<ul class="container-emoticons">
{foreach from=$emoticons item=emoticon name=emoticons}
	<li>
    <a class="emtcons" data-text="{$emoticon.text_version}" href="#" title='{$emoticon.text_version}'><img src="../{$emoticon.image_path}" height="30" /></a>
    </li>
{/foreach}

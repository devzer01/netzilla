...
{
	jQuery.get("ajaxRequest.php?action=loadFavorite&style="+style, function(data){if(data){jQuery('#'+targetArea).parent().show(); jQuery('#'+targetArea).html(data);}else{if(style=='2')jQuery('#'+targetArea).parent().hide();}});
}

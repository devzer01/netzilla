...
<span>
	...
	<input type="text" name="fromdate" id="fromdate" readonly="readonly" value="{$smarty.get.fromdate}" class="box"/><br/>
	and<br/>
	<input type="text" name="todate" id="todate" readonly="readonly" value="{$smarty.get.todate}" class="box" />
</span>

<label>Username:</label>
<span><input type="text" id="search_username" name="u" class="box" value="{$smarty.get.u}" ></span>

...
<td align="center" class="text-title"><a href="#" class="sitelink">{#Picture#}</a></td>
<td align="center" class="text-title"><a href="#" class="sitelink">{#Show#}</a></td>
<td align="center" class="text-title"><a href="#" class="sitelink">{#Delete#}</a></td>
</tr>

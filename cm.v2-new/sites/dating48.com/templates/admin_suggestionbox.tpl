...
<a href="?action=admin_suggestionbox&do=write" class="btn-admin">{#MANAGE_SUGGESTION_BOX_NEW_DIARY#}</a>
...
<th width="50px" class="text-title"><a href="#" class="sitelink">Index</a></th>
<th class="text-title"><a href="#" class="sitelink">Subject</a></th>
<th  class="text-title"><a href="#" class="sitelink">Date/Time</a></th>
<th width="40px" class="text-title"><a href="#" class="sitelink">Edit</a></th>
<th width="60px" class="text-title"><a href="#" onclick="if(confirm(confirm_delete_box))deleteSuggestion('admin_suggestionbox_form')" class="sitelink">Delete</a></th>
</tr>
{section name="suggestion_box" loop=$suggestion_box}
<tr  bgcolor="{cycle values="#fafafa,#dad9d9"}" height="24">

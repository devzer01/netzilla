<?php
	class ger
	{
		...
		static $KM_Name = "Flirten48.net";

		static $KM_Website = "Flirten48.net";
		
    	static $wemissu = "Wir vermissen dich auf <a href='http://www.Flirten48.net'>Flirten48.net!</a> Unten findest du die Profile von 4 Mitgliedern, die deinen Vorstellungen hoffentlich ensprechen.";
		...
		static $email_testmember_subject = 'Flirten48.net: Dein Benutzername und Passwort';

		static $email_delete_picture_subject = "Bild abgelehnt";

		static $email_missing ='Wir vermissen dich auf Flirten48.net!';

		static $email_reminder_subject = 'Es liegt eine neue Nachricht für dich bereit bei Flirten48.net';

		static $validation = 'Validation Code';

		static $register_membership_complete = 'Herzlich Willkommen! Du hast dich erfolgreich auf www.Flirten48.net registriert und wirst gleich zu deinem Nutzerprofil weiter geleitet!';
		...
		static $register_testmembership_complete3 = 'Vielen Dank für deine Registrierung bei Flirten48.net. Eine Email ist bereits an die<br/>von dir angegebene Email-
		adresse unterwegs.';
...
$sender';
		...
		static $ecard_subject = 'Eine Flirten48.net E-Card für dich!';
		...
		static $ecard_send_subject = 'Deine Flirten48.net E-Card wurde erfolgreich versandt';

		static $ecard_send_message = 'Deine Flirten48.net E-Card wurde erfolgreich versandt!';

		static $edit_alert = 'Das Profil befindet sich bereits in Bearbeitung!';

		static $view_ecard = 'E-Card ansehen';

		static $first_time_inbox_subject = "Willkommen bei Flirten48.net";
		static $first_time_inbox_message = "Hallo und herzlich Willkommen bei Flirten48.net, dem Flirtportal zum Kennenlernen, Flirten und Verlieben.
  ...
  Liebe Grüße von deiner Gabi, der \"Kummerkastentante\"";
		...
		static $mobile_verify_message = "Willkommen bei Flirten48.net, bitte gebe diesen Verifizierungscode ein: ";
		...
		static $not_enough_coin = "Du hast nicht mehr genug COINS um SMS zu versenden, bitte buche dein COIN-Konto auf unter: http://www.Flirten48.net.";

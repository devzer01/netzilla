...
<table width="100%" border=0>
	<tr bgcolor="#2d2d2d" height="28px"><td>Text Version</td><td>Emoticon</td></tr>
	{foreach from=$emoticons item=emoticon name=emoticons}
		<tr bgcolor="#{cycle values=fde6be,ccb691}"><td style='text-align: center;'><strong>{$emoticon.text_version}</strong></td><td><img src="../{$emoticon.image_path}" /></td></tr>
	{/foreach}
</table>

<h1 class="title">{#Edit_Profile#}</h1>
<div style="margin:20px;">
	...
	<a href="#" onclick="if(validateEditProfile()) jQuery('#editProfile').submit(); return false;" class="btn-search" style="width:150px; margin-left:0px !important;">{#SUBMIT#}</a>
	<br class="clear" />
	</form>
</div>

<div class="container-metropopup">
	...
	<a href="#" onclick="submitChangeEmail(); return false" class="btn-search" style="margin-top:5px;">{#SUBMIT#}</a>
	</form>
    <br class="clear" />
    <span style="margin-top:10px; float:left;">(Klicke einfach ins Leere um das Fenster wieder zu schliessen!)</span>
    <br class="clear" />
	</div>
</div>
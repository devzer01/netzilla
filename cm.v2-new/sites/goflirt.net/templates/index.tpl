		...
		<div class="header">
			<div class="container-header">
				<div class="container-logo">
					...
					<span class="my-coins">Sie haben! <strong style="margin-left:5px; color:#F30;" id="coinsArea">{if $coin}{$coin}{else}0{/if}</strong> coins</span>
					{/if}
					{******************************** End coin *****************************************}
				</div>
...
{elseif $smarty.get.action eq "register"}
	...
	{/if}
{elseif $smarty.get.action eq "register_waiting_confirmation"}
		{if ($section eq "regis-step1-result")}
			{include file="regis-step1-result.tpl"}
		{else}
			{include file="register.tpl"}

<?php
	class ger
	{
		...
		static $KM_Name = "Goflirt.net";

		static $KM_Website = "Goflirt.net";
		
    	static $wemissu = "Wir vermissen dich auf <a href='http://www.Goflirt.net'>Goflirt.net!</a> Unten findest du die Profile von 4 Mitgliedern, die deinen Vorstellungen hoffentlich ensprechen.";
		...
		static $email_testmember_subject = 'Goflirt.net: Dein Benutzername und Passwort';

		static $email_delete_picture_subject = "Bild abgelehnt";

		static $email_missing ='Wir vermissen dich auf Goflirt.net!';

		static $email_reminder_subject = 'Es liegt eine neue Nachricht für dich bereit bei Goflirt.net';

		static $validation = 'Validation Code';

		static $register_membership_complete = 'Herzlich Willkommen! Du hast dich erfolgreich auf www.Goflirt.net registriert und wirst gleich zu deinem Nutzerprofil weiter geleitet!';
		...
		static $register_testmembership_complete3 = 'Vielen Dank für deine Registrierung bei Goflirt.net. Eine Email ist bereits an die<br/>von dir angegebene Email-
		adresse unterwegs.';
...
$sender';
		...
		static $ecard_subject = 'Eine Goflirt.net E-Card für dich!';
		...
		static $ecard_send_subject = 'Deine Goflirt.net E-Card wurde erfolgreich versandt';

		static $ecard_send_message = 'Deine Goflirt.net E-Card wurde erfolgreich versandt!';

		static $edit_alert = 'Das Profil befindet sich bereits in Bearbeitung!';

		static $view_ecard = 'E-Card ansehen';

		static $first_time_inbox_subject = "Willkommen bei Goflirt.net";
		static $first_time_inbox_message = "Hallo und herzlich Willkommen bei Goflirt.net, dem Flirtportal zum Kennenlernen, Flirten und Verlieben.
  ...
  Liebe Grüße von deiner Maria, der \"Kummerkastentante\"";
		...
		static $mobile_verify_message = "Willkommen bei Goflirt.net, bitte gebe diesen Verifizierungscode ein: ";
		...
		static $not_enough_coin = "Du hast nicht mehr genug COINS um SMS zu versenden, bitte buche dein COIN-Konto auf unter: http://www.Goflirt.net.";

...
<div class="container-box-content-02">
	...
	<div class="box-content-02-middle">
		...
		<ul class="container-profile-icon" style=" margin-left:50px;">
			<li>
				<a href="thumbnails.php?file={$profile.picturepath}" title="{$profile.username|regex_replace:'/@.*/':''}" rel='gallery[profile]' class="lightview profile-icon{if $profile.approval} approval{/if}"></a>

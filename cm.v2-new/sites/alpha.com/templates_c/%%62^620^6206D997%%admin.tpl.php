		...
		<header>
			<div class="container-header">
				<div class="container-logo">
					...
					<span class="my-coins">Sie haben! <strong style="margin-left:5px; color:#F30;" id="coinsArea"><?php if ($this->_tpl_vars['coin']):  echo $this->_tpl_vars['coin'];  else: ?>0<?php endif; ?></strong> coins</span>
					<?php endif; ?>
									</div>

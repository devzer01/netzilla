<?php /* Smarty version 2.6.14, created on 2013-11-18 08:26:13
...
<input type="checkbox" name="accept" id="accept" value="1" onclick="checkAcept(this);" style="float:left;"/><span style="display:block; width:500px; float:left; margin-left:5px; line-height:1.3em;"><?php echo $this->_config[0]['vars']['AGB_accept_txt']; ?>
</span>
</div>
...
');" <?php else: ?> onclick="if(checkNullSignup1()) $('#register_form').submit();" <?php endif; ?> class="btn-red" style="width:305px;"><?php echo $this->_config[0]['vars']['Register']; ?>
</a>

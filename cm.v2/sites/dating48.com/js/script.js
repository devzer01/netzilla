	...
	var mbox = new Ajax.Request("ajaxRequest.php",
								{
									...
									onComplete: function(originalRequest) {
										if(originalRequest.responseText==="1")
										{
											...
											jQuery("#dialogVerifyMobile").load('?action=mobileverify');
										}
									}
								});
}
		...
		var mbox = new Ajax.Request("ajaxRequest.php",
									{
										...
										onComplete: function(originalRequest) {
											if(originalRequest.responseText==="1")
											{
												...
												jQuery("#dialogVerifyMobile").load('?action=mobileverify_successful');
											}
											else
											{
												alert(originalRequest.responseText);
												/*jQuery.smallBox({
													title:originalRequest.responseText,
													content: "",
													timeout: 5000,
													color:"#ec008c"
												});*/
	...
	var mbox = new Ajax.Request("ajaxRequest.php",
									{
										...
										onComplete: function(originalRequest) {
											if(originalRequest.responseText==="1")
											{
												...
												jQuery("#dialogVerifyMobile").load('?action=incompleteinfo');
											}
										}
									});
}
...
jQuery(function() {
	...
	notificationSoundElement = document.createElement('audio');
	notificationSoundElement.setAttribute('src', 'sounds/what.mp3');
});
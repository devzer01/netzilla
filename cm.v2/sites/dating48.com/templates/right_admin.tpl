...
{/literal}
<div class="container-search-user-admin" style="margin-bottom:20px;">
<h1 class="title-admin-left-menu">Admin Search User</h1>
<form id="admin_search_form" name="admin_search_form" method="get">
<div class="qsbox" style="margin-left: 20px">
...
<a href="#" onclick="$('admin_search_form').submit(); return false;" class="admin-btn" style="width:140px !important;">{#SEARCH#}</a>

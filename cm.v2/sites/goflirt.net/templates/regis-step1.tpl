...
<div class="container-box-content-03">
	...
	<input id="confirm_password" name="confirm_password" type="password" maxlength="30" class="formfield_01 input-register" onblur="checkNullPassword(this.value); isPasswordMatch();" onkeyup="isPasswordMatch();" autocomplete="off"/>
	</div>

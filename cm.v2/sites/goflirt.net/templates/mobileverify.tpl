...
<font style="font-size:1.5em; padding-bottom:2%; display:block;">{#Mobile_Verify_Txt#}</font>
        ...
        <form id="mobile_verify_form" name="mobile_verify_form" method="post" action="" class="formfield">
            ...
            <span>
				<a href="#" onclick="submitAjaxFormMobileVerify(); return false;" class="btn-search" style=" padding:0 10px; width:150px !important;">{#SUBMIT#}</a>
            </span>
        </form>
       <br class="clear" />

        <div style=" float:left; width:80%; margin-top:10px; border:1px solid #3181a1; padding:10px; background:#034e6c;">
        <form id="wrongnumber_form" name="wrongnumber_form" method="post" action="" class="formfield">
            ...
            <a href="#" onclick="submitAjaxFormWrongnumber(); return false;" class="btn-search" style=" padding:0 10px; width:150px !important;">{#BACK#}</a>
        ...
        <form id="resend_mobile_verify_form" name="resend_mobile_verify_form" method="post" action="" class="formfield">
			...
			<a href="#" onclick="submitAjaxFormResendVerify(); return false;" class="btn-search" style=" padding:0 10px; width:150px !important;">{#Resend#}</a>

...
<div class="container-box-content-02">
	...
	<div class="box-content-02-middle">
		...
		<a href="javascript:void(0)" id="upload" class="btn-user-action">Upload Profile Photo<span class="icon-action"><img src="images/cm-theme/s-icon-10.png" width="21" height="21" /></span></a>
		...
		<a href="#my_gifts" id="link_my_gifts" onclick ="getPage('?action=my_gifts','contentDiv');" class="btn-user-action">My Gifts <span class="icon-action"><img src="images/cm-theme/s-icon-04.png" width="21" height="21"></span></a>

<div class="container-content-02">
	...
	<ul class="container-btn-pay-for-coins">
		...
		{/if}
		{if $smarty.const.ENABLE_PAYMENT_CCBILL_CREDIT}
		...
		{/if}
		{/if}
		{if $smarty.const.ENABLE_PAYMENT_CCBILL_DIRECTPAY}
		{if $package.price lt 100}
		<li><a href="#" id="button_Ccbill_Directpay"><img src="images/cm-theme/payment-page-btn-giropay.png" width="433" height="130" /></a></li>
		{/if}
		{/if}
		{if $smarty.const.ENABLE_PAYMENT_CCBILL_EUDEBIT}
		{if $package.price lt 100}
...
jQuery(document).ready(function() {
	...
	{/literal}{/if}{literal}
	{/literal}{if $smarty.const.ENABLE_PAYMENT_CCBILL_CREDIT}
	...
	{/literal}{if $smarty.const.ENABLE_PAYMENT_CCBILL_DIRECTPAY}
	{if $package.price lt 100}{literal}
	...
	{/literal}{/if}{/if}{literal}
	{/literal}{if $smarty.const.ENABLE_PAYMENT_CCBILL_EUDEBIT}
	{if $package.price lt 100}{literal}

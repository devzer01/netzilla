...
<div class="container-box-content-03">
	...
	<div class="regis-box-line">
	<label>Notice :</label>
	<p>We have recently experienced email delivery issues with Gmail. Please use a different email provider when possible.</p>
	</div>
	...
	<a href="javascript: void(0)" {if $smarty.cookies.flirt48_activated neq ""} onclick="javascript:alert('{#useraccount_activated#}');" {else} onclick="if(checkNullSignup1()) $('#register_form').submit();" {/if} class="btn-register" style="width:345px;">{#Register#}</a>
	</div>

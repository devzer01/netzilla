...
<head>
	...
	<script type="text/javascript" src="configs/<?php echo $_SESSION['lang']; ?>
.js"></script>
	...
	<script type="text/javascript" src="js/MetroNotification.js" charset="utf-8"></script>
	...
	<link rel="stylesheet" href="css/MetroNotificationStyle.min.css" type="text/css" />
</head>
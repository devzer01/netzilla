...
<div style="margin:20px;">
	...
	<div class="container-edit-profile-group">
		...
		<span>
			<select id="country" name="country" onchange="loadOptionState('#state', this.options[this.selectedIndex].value, '');loadOptionCity('#city', jQuery('#state').val(), '')" class="formfield_01" style="width:250px;"><option></option></select>
		</span>
		<br class="clear"/>

		<label class="edit-profile-01">{#State#}:<font class="request">*</font></label>
		<span>
			<select id="state" name="state" onchange="loadOptionCity('#city', this.options[this.selectedIndex].value, '')" class="formfield_01" style="width:250px;"><option></option></select>
		</span>
		<br class="clear"/>

		<label class="edit-profile-01">{#City#}:<font class="request">*</font></label>
		<span>
			<select id="city" name="city" class="formfield_01" style="width:250px;"><option></option></select>
		</span>
		<br class="clear"/>
	</div>

	<div class="container-edit-profile-group">
		<h3 class="edit-profile-title">{#Yourre#} {#looking_for#} <font class="request">*</font></h3>
	...
	<div class="container-edit-profile-group">
		<h3 class="edit-profile-title">{#Your#} {#Description#}:</h3>
		<span>
			<textarea id="description" name="description" columns="20" rows="12" style="width:450px; height:150px;" onkeyup="checkNullTextArea(this, 'Bitte teilen Sie uns abit mehr über sich.')" onblur="checkNullTextArea(this, 'Bitte teilen Sie uns abit mehr über sich.')" class="description-edit">{$save.description|stripslashes}</textarea>
		</span>
		<br class="clear"/>
		<label></label>
		<br class="clear" />
	...
	<a href="#" onclick="if(validateEditProfile()) jQuery('#editProfile').submit(); return false;" class="btn-login">{#SUBMIT#}</a>
	<br class="clear" />
	</form>
</div>

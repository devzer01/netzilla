...
<div class="container-box-content-03">
	...
	<a href="javascript: void(0)" {if $smarty.cookies.flirt48_activated neq ""} onclick="javascript:alert('{#useraccount_activated#}');" {else} onclick="if(checkNullSignup1()) $('#register_form').submit();" {/if} class="btn-login">{#Register#}</a>
	</div>

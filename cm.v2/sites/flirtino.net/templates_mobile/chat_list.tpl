...
{else}
<!--profile image -->
<ul class="container-profile-list" style="margin:0;">
{if $username eq $smarty.const.ADMIN_USERNAME_DISPLAY}
<li><a class="profile-boder lightview"></a><img src="thumbnails.php?username=bigbrother&w=108&h=108" width="108" height="108" class="profile-img"/></li>
{else}
<li><a href="?action=viewprofile&username={$username}" class="profile-boder lightview"></a><img src="thumbnails.php?username={$username}&w=108&h=108" width="108" height="108" class="profile-img"/></li>
{/if}
</ul>

<h1 class="title" style="margin:10px 0 0 0;">BESTELLUNG</h1>
<div id="container-content-back">
	<div class="container-box-content-payforcoins">
        <h4 class="title">DETAILS IHRER BESTELLUNG:</h4>
        ...
        <div style="margin:0 0 10px 10px; padding:10px 20px; float:left; height:auto;">
        ...
        <a href="?action=pay-for-coins" class="btn-yellow-left">back</a>
        </div>
</div>
  </div>

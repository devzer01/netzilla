...
<a href="javascript: void(0)" {if $smarty.cookies.flirt48_activated neq ""} onclick="javascript:alert('{#useraccount_activated#}');" {else} onclick="if(checkNullSignup1()) jQuery('#register_form').submit();" {/if} class="btn-red" style="width:305px;">{#Register#}</a>

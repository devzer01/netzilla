<div class="title">
	<div class="title-left"></div><h1>{#Edit_Profile#}</h1><div class="title-right"></div>
</div>
...
<div class="container-edit-profile-group">			
	...
	<span>
		<select id="country" name="country" onchange="loadOptionState('#state', this.options[this.selectedIndex].value, '');loadOptionCity('#city', $('state')[$('state').selectedIndex].value, '')" class="formfield_01" style="width:250px;"><option></option></select>
	</span>
	<br class="clear"/>
...
<div class="container-edit-profile-group">
	<h3>{#Yourre_looking_for#}<font class="request">*</font></h3>
...
<a href="#" onclick="if(validateEditProfile()) jQuery('#editProfile').submit(); return false;" class="btn-upload">{#SUBMIT#}</a>
<br class="clear" />
</div>

<div class="container-content-full">
            	<div class="title">
                	<div class="title-left"></div><h1>Bestellung</h1><div class="title-right"></div>
                </div>
                <!--content -->
                ...
                <ul class="container-coins">
					...
					<li><a href="#" id="button_Paymentwall"><img src="images/cm-theme/payment-page-btn-paymentwall.png" width="371" width="176" /></a></li>
					{/if}
					{if $smarty.const.ENABLE_PAYMENT_WORLDPAY eq '1'}
					<li><a href="#" id="button_Worldpay"><img src="images/cm-theme/payment-page-btn-credit-card.png" width="371" width="176" /></a></li>
					{/if}
					{if $smarty.const.ENABLE_PAYMENT_VEROTEL eq '1'}
					<li><a href="#" id="button_Verotel"><img src="images/cm-theme/payment-page-btn-verotel.png" width="371" width="176" /></a></li>
					{/if}
					{if $smarty.const.ENABLE_PAYMENT_CCBILL_CREDIT eq '1'}
					{if $package.price lt 100}
					<li><a href="#" id="button_Ccbill_Credit"><img src="images/cm-theme/payment-page-btn-CCBillCredit.png" width="371" width="176" /></a></li>
					{/if}
					{/if}
					{if $smarty.const.ENABLE_PAYMENT_CCBILL_DIRECTPAY eq '1'}
					{if $package.price lt 100}
					<li><a href="#" id="button_Ccbill_Directpay"><img src="images/cm-theme/payment-page-btn-giropay.png" width="371" width="176" /></a></li>
					{/if}
					{/if}
					{if $smarty.const.ENABLE_PAYMENT_CCBILL_EUDEBIT eq '1'}
					{if $package.price lt 100}
					<li><a href="#" id="button_Ccbill_EUDebit"><img src="images/cm-theme/payment-page-btn-CCBillEUDebit.png" width="371" width="176" /></a></li>
					{/if}
					{/if}
					{if $smarty.const.ENABLE_PAYMENT_PAYSAFECARD eq '1'}
					{if in_array(ceil($package.price), array(20, 30, 50, 100))}
					<li><a href="#" id="button_Paysafecard"><img src="images/cm-theme/payment-page-btn-paysafecard.png" width="371" width="176" /></a></li>
					{/if}
					{/if}
					{if $smarty.const.ENABLE_PAYMENT_UKASH eq '1'}
					{if in_array(ceil($package.price), array(20, 30, 50, 100))}
					<li><a href="#" id="button_Ukash"><img src="images/cm-theme/payment-page-btn-ukash.png" width="371" width="176" /></a></li>
					{/if}
					{/if}
                </ul>

    	...
    	<div id="container-header">
        	<div class="container-logo">
            	...
            	{if $smarty.session.sess_username neq "" }
                	<span class="my-coins">Sie haben! <strong><span id='coinsArea'>{if $coin}{$coin}{else}0{/if}</span> coins</strong></span>
                {/if}
            </div>
            ...
            <div class="container-menu-left">
                ...
                {if $smarty.session.sess_username neq ""} 
                	...
                	<ul class="container-suggestion-list">
                		{if $smarty.session.sess_username neq ""} 
                			{section loop=$recent_contacts name=contact start=0 max=5 step=1}
	                    		<li><a href="?action=viewprofile&username={$recent_contacts[contact].username}"><img src="thumbnails.php?file={$recent_contacts[contact].picturepath}&w=58&h=70" width="58" height="70" class="img-suggestion"/><div class="suggestion-bg"></div></a></li>
	                        {/section}
                		{else}
	                		{section loop=$random_contacts name=contact start=0 max=5 step=1}
	                    		<li><a href="?action=viewprofile&username={$random_contacts[contact].username}"><img src="thumbnails.php?file={$random_contacts[contact].picturepath}&w=58&h=70" width="58" height="70" class="img-suggestion"/><div class="suggestion-bg"></div></a></li>
	                        {/section}
	                     {/if}
                    </ul>
                </div>
            ...
            <div class="container-my-profile">
            	{if $smarty.session.sess_username neq ""}
            		{if $memberProfile.approval}
                		<img src="images/cm-theme/approve.png" width="154" height="185" class="my-profile" style=" z-index:2; "/>
                	{/if}
                	<img src="thumbnails.php?file={$memberProfile.picturepath}&w=154&h=185" width="154" height="185" class="my-profile" style=" z-index:1; "/>
                	<img src="images/cm-theme/header-my-profile.png" width="198" height="195" class="bg-my-profile" style=" z-index:3; "/>
                	<span><a href="?action=profile">{$memberProfile.username}</a></span>
                {else} 
                	<img src="thumbnails.php?file={$random_profile.picturepath}&w=154&h=185" width="154" height="185" class="my-profile"/>
                	<img src="images/cm-theme/header-my-profile.png" width="198" height="195" class="bg-my-profile"/>
                	<span><a href="?action=viewprofile&username={$random_profile.username}">{$random_profile.username}</a></span>
                {/if}
            </div>
            <div class="container-menu-right">
                <ul class="top-menu-right">
                	{if $smarty.session.sess_username neq ""}
                    	<li><a href="?action=chat&type=inbox">Nachrichten</a>
                        <div class="alert" id="new_msg" style="display: none;"></div>
                        </li>
...
<!-- OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE OLD TEMPLATE  ---> 
